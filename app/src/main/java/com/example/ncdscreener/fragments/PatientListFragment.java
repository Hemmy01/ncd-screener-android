...
public class PatientListFragment extends Fragment {
                ...
                try {
                    ...
                    view.postDelayed(() -> {
                        try {
                            ...
                            Toast.makeText(getContext(), "Error opening patient details", Toast.LENGTH_SHORT).show();
                        }
                    }, 150);
                } catch (Exception e) {
                    android.util.Log.e("PatientListFragment", "Error selecting patient", e);
                    Toast.makeText(getContext(), "Error selecting patient", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(getContext(), "Invalid patient data", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void setupExportButton() {
        buttonExport.setOnClickListener(v -> {
            if (allPatients == null || allPatients.isEmpty()) {
                Toast.makeText(getContext(), "No patients to export", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private void exportData(String format) {
        try {
            ...
            Toast.makeText(getContext(), "Export error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }

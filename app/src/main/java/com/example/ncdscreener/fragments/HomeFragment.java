...
public class HomeFragment extends Fragment {
    ...
    private void setupClickListeners() {
        ...
        cardNewScreening.setOnClickListener(v -> {
            ...
            Navigation.findNavController(v).navigate(R.id.action_home_to_new_screening);
        });
        ...
        cardTodayScreenings.setOnClickListener(v -> Navigation.findNavController(v).navigate(R.id.action_home_to_screening_list));
    }

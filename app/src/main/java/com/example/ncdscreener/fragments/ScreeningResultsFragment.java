...
public class ScreeningResultsFragment extends Fragment {
    ...
    private void generateReferral() {
        ...
        if (screening == null) {
            Toast.makeText(getContext(), "No screening data available", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Toast.makeText(getContext(), "Referral generated: " + referralCode, Toast.LENGTH_LONG).show();
    }
}

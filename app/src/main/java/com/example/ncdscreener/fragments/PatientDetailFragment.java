    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        buttonEditPatient.setOnClickListener(v -> {
            ...
            if (patient != null && patient.getPatientId() > 0) {
                ...
                ToastHelper.showError(getContext(), "Patient information is not available. Please select a patient first");
            }
        });
    ...
    private void showDeleteConfirmationDialog(Patient patient) {
        new androidx.appcompat.app.AlertDialog.Builder(requireContext())
            ...
            .setPositiveButton("Delete", (dialog, which) -> {
                ...
                ToastHelper.showSuccess(getContext(), "Patient and all associated screenings have been deleted successfully");
